    ...
    <div className="max-w-2xl mx-auto mt-8">
      ...
      <div className="mt-8">
        ...
        <div className="flex gap-4 flex-wrap">
          {filteredArtists.length === 0 && <div className="text-neutral-400">No artists found.</div>}
          {filteredArtists.map(artist => (
            <div key={artist.name} className="flex flex-col items-center bg-secondary rounded-xl p-4 w-32">
              <img src={artist.image} alt={artist.name} className="w-16 h-16 rounded-full mb-2" />
